"""Example usage, from preexisting masks

If you already have compatible masks (e.g., generated by setting 'output_masks' to True), you don't have to rerun the
entire pipeline. Instead, you can skip straight to the optimized CellStitch calculation. Or, perhaps you want to compare
